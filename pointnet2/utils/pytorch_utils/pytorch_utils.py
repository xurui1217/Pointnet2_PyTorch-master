...
def checkpoint_state(
        model=None, optimizer=None, best_prec=None, best_loss=None, epoch=None, it=None
):
...
def save_checkpoint(
    ...
    if is_best:
        ...
        #shutil.copyfile(filename, '{}.pth'.format(bestname))
...
class Trainer(object):
    ...
    def _train_it(self, it, batch):
        ...
        _, loss, eval_res = self.model_fn(self.model, batch)  #eval_res={'acc': 0.1875, 'loss': 4.0884552001953125}
